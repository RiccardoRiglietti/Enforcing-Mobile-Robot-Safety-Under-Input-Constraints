function [dbi_inf, dbi_sup, x_new, y_new] = cbf(x, f, g, bi, umax, vmax, dmax)
%% [dbi_inf, dbi_sup, x_new, y_new] = cbf(x, f, g, bi, umax, vmax, dmax)
...
% dbi_inf and dbi_sup are used to compute the next CBF 
...
function y = bi_sub_x2(bi, x2_val)
%% y = bi_sub_x2(bi, x2_val)
% returns the numerical absolute value of bi
    
    syms x2 real 
    y = double(abs(subs(bi, x2, x2_val)));
